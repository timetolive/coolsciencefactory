...
<html lang="en">
  <head>
    ...
    <title>Starboard Technology Partner</title>
  ...
  <body>
        ...
        <div class="carousel-item">
          ...
          <div class="container">
            <div class="carousel-caption d-block text-left">
              ...
              <p><a id="btn-3" class="btn btn-lg btn-primary d-none d-md-inline-block" href="#" role="button">Better way</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container marketing">
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">As your partner, our goal is for YOU <span class="text-muted">to succeed.</span></h2>
          <p class="lead">We think of ourselves as partners, because when you take us on, we take your goals, timelines and your budget seriously.</p>
        </div>
        <div class="col-md-5">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <p class="text-justify fixh"><span class="quotes">&ldquo;</span>They optimized our 3 virtual development teams, mentoring and optimizing agile and continuous delivery. We say drammatic improvements in overall efficiency and quality.<span class="quotes">&rdquo;</span></p>
          <p><a class="btn btn-secondary" href="#" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
